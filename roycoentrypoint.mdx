...
- Deployers can optionally enable the oracle gate; executing a deposit request only after the collateral asset's oracle posts a new price update. This prevents someone from submitting a deposit just before a scheduled NAV update to capture yield from a period they did not hold through.
