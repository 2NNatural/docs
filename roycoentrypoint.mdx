...
**RoycoEntryPoint** is the protocol's tranche deposit gateway contract. All deposits into Royco markets are routed through the RoycoEntryPoint rather than depositing directly into tranche contracts. This design enables several protocol-level safeguards:
