...
Once submitted, a request becomes executable after a waiting period. Once a request's delay elapses, anyone can execute it in a separate transaction; the depositor can attach an optional executor bonus to incentivize a third party.
