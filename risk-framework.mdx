...
ERC4626 vaults are susceptible to share inflation attacks, where an attacker manipulates the share price to cause rounding losses for subsequent depositors. 
