...
ERC4626 vaults are susceptible to share inflation attacks, where an attacker manipulates the share price to cause rounding losses for subsequent depositors. Deployers should ensure that they have deposited 1e9 shares  Before interacting with a vault, verify that a dead deposit has been made. 
