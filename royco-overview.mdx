...
Yield flows from the ST to both JT and LPT, paying for Senior's coverage and liquidity based on pre-defined ratios.
...
**LPT gets paid to be the exit.** LPT is the counterparty for ST redemptions, providing liquidity to an AMM pool composed of ST shares and stablecoins. LPT earns a liquidity premium and trading fees, as well as buying shares at a discount when ST sells shares into the pool.
