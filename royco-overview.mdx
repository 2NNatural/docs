...
**SLP gets paid to be the exit.** SLP is the counterparty for ST redemptions, providing liquidity to an AMM pool composed of SLP shares and stablecoins. SLP earns a liquidity premium and trading fees, as well as buying shares at a discount when ST sells shares into the pool.
