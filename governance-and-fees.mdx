---
title: "Governance and Fees"
description: "Royco's per-market parameters — coverage minimums, premium caps, liquidity requirements, observation windows — and the protocol fee structure."
---
...
| Liquidity tranches | 0% | 0% | 0% |

For swaps, LiFi route fees apply at a rate of 3 bps for stablecoins and 20 bps for assets not classified as stablecoins.

_Where applicable, performance fees are calculated on yield generated, defined as all income received by a vault minus borrowing costs. No fee is charged in periods where the yield is zero or negative. Fees are visible onchain. Prior versions of the protocol included a junior tranche fee that is not applicable with the latest version._
