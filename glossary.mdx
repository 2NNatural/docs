---
title: "Glossary"
description: "Definitions of Royco terms: Senior, Junior, and SLP tranches, utilization, coverage, risk and liquidity premiums, observation period, and more."
---

**Senior Tranche (ST):** First-loss covered capital. Earns the base asset’s yield minus a risk premium paid to JT (for loss coverage) and a liquidity premium paid to SLP (for secondary liquidity). Backed by JT first-loss capital and exitable via the SLP pool or Protected Exit.
...
**Senior Liquidity Provider (SLP):** Capital that provides secondary liquidity for ST by seeding an AMM pool of ST shares and a stablecoin. Earns a liquidity premium, trading fees, ST appreciation, and stablecoin yield, minus impermanent loss.
...
**Yield Distribution Model (YDM):** Royco uses separate YDMs for JT’s risk premium and SLP’s liquidity premium. Depending on the selected model, each premium may be fixed or determined by a utilization-sensitive curve.

**Coverage Utilization:** How close JT coverage sits to its required minimum floor. Drives the risk premium. 

**Liquidity Utilization:** How close SLP secondary liquidity sits to its required minimum floor. Drives the liquidity premium.
...
**Liquidity Premium:** The share of Senior yield paid to SLP in exchange for providing secondary liquidity. Sized by liquidity utilization through the YDM, and paid as Senior Tranche shares that are progressively redeployed into SLP's liquidity position.

**Observation Period:** A per-market recovery window that may begin when an accounting sync observes a collateral drawdown absorbed by JT and leaves a recoverable JT loss. JT effective NAV is marked down during the period, but JT cannot redeem and subsequent collateral recovery restores the outstanding JT loss first. If the drawdown reverses within the window, no loss is realized; if it persists past the window (or breaches the Protected Exit Threshold), the loss is allocated to JT. During the Observation Period, direct ST redemptions, new JT deposits, and SLP redemptions are paused and 100% of yield routes to rebuilding JT's buffer. However, ST can still exit through the SLP pool. Window length is set per market and may be 0 days (immediate finalization).
