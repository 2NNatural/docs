...
**Yield Distribution Model (YDM):** The mechanism that splits base-asset yield among the tranches. Sets JT's risk premium from coverage utilization and SLP's liquidity premium from liquidity utilization, each via a per-market yield curve, with the two premiums jointly capped so they never exceed 100% of Senior yield.
